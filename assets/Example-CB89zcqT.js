const t=`import { useEffect, useState } from 'react'
...
export default function MassiveDataSet() {
  ...
  // initial bundle — it's fetched on demand, behind the loading state below.
  // A Vite plugin parses the \`.json5\` to a plain object at build time.
  useEffect(() => {
    let cancelled = false
